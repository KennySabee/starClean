      ...
      <div className="relative">
            ...
            <div className="relative px-6 pt-32 pb-16 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                <div className="hidden sm:mb-10 sm:flex">
                  ...
                  Empresa encargada de la limpieza y desinfección de muebles.&nbsp; 
                    <a
                ...
                Resultados inmediatos que te dejarán impresionado .
                </p>
                <div className="mt-10 flex items-center justify-center sm:justify-start gap-x-6">
                  ...
                  >
                    Preguntas Frecuentes <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <Image
            ...
            src="https://res.cloudinary.com/kennysabee/image/upload/v1718654981/starClean/logo.jpg"
            alt="fondoHero"
            width={800}
            height={800}
          />
